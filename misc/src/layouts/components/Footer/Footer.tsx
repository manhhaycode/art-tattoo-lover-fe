        ...
        <footer className="">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="https://art-tattoo-lover.vercel.app/" className="flex items-center">
                            ...
                            <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">Tattus</span>
                        </a>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm  sm:text-center text-gray-400">© 2023 <a href="https://art-tattoo-lover.vercel.app/" className="hover:underline">Tattus™</a>. All Rights Reserved.
                    </span>
